...
as skew from washing
                    """ %(meanTemperature(df,spark),sdTemperature(df,spark))).first().skew
...
as kur from washing
                    """ %(meanTemperature(df,spark),sdTemperature(df,spark))).first().kur
...
def correlationTemperatureHardness(df,spark):
    return spark.sql("""
SELECT 
    corr(temperature, hardness) as corr from washing
                    """).first().corr
